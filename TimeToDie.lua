...
function RotationHelper:InitTTD(maxSamples, interval)
...
function RotationHelper:DisableTTD()
...
local HPTable = {};
local trackedGuid;
function RotationHelper:TimeToDie(trackedUnit)
...
function RotationHelper:GetTimeToDie()
	local seconds = 5*60;
